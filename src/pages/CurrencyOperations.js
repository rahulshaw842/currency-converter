...
export default function CurrencyOperations() {
    ...
    const calculate = () => {
        ...
        const result = FirstMoney.arithmaticOperation(secondMoneyConvertedData, operator)
        setResult(result);
        ...
        <Grid container>
            ...
            <Grid item md={8} style={{ width: '100%' }}>
                <Card variant="outlined">
                    <div className="heading"> Currency Arithmatic Operations</div>
                    <CardContent>
                    ...
                    <div className="button-center">
                        <Button variant="contained" color="primary" className="margin-bottom" onClick={calculate} disabled={!Amount1 || !Amount2 || !Currency1 || !Currency2 || !operator}>                         Calculate
                        </Button>
                    </div>
                    {isResultShow && <div style={{ textAlign: 'center' }}>
                        <Typography variant="h6">
                            Result: {`${result} ${Currency1}`}
                        </Typography>
                    </div>
                    }
                </Card>
